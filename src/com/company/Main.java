...
public class Main {
    ...
    public static void main(String[] args) /*throws IOException, /*RomaNumberNotIntervalException */{
       ...
       try {
           ...
           boolean patternRom = str.matches("[IVX]+[ ]{1}[\\+-/*][ ]{1}[IVX]+"); //сверка с "грубым" шаблоном с римскими цифрами
            ...
            //   System.out.println("Выражение соответствует шаблону с арабскими числами");
             ...
             //  System.out.println("Выражение не соответствует шаблону с арабскими числами!");
               if (patternRom) {
                   ...
                   System.out.println("Значение выражения = " + rom.ResultatRom());
